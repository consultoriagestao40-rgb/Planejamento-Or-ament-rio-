...
console.log(`Categoria Col: ${colCat}, Valor Col: ${colVal}`);
...
for (let idx = 0; idx < data.length; idx++) {
    ...
    if (categoriaRaw.includes('01.1')) {
        totalRev += finalAmount;
        console.log(`+ ${finalAmount} | ${categoriaRaw}`);
    } else if (categoriaRaw.includes('03.1.1')) {
        totalExp += finalAmount;
        console.log(`- ${finalAmount} | ${categoriaRaw}`);
    }
}
console.log("TOTAL RECEITA DETECTADA V51.3 LOGIC:", totalRev);
console.log("TOTAL SALARIOS DETECTADOS V51.3 LOGIC:", totalExp);
