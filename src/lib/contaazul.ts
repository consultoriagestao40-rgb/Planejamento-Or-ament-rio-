...
// V33: A ROTA DEFINITIVA - Usando api.contaazul.com (Legado Real)
// Confirmado via teste que esta URL aceita o escopo 'finance' que precisamos.
...
export const getAuthUrl = (state: string) => {
    ...
    // V33: Usando os escopos que o sistema Legado entende.
